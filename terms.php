                ...
                <div class="page contextual-page mb-0">
                    <div class="inner">
                        ...
                        <div class="text-widget">
                            <div class="inner">
                                <h4>Rent-a-lot Terms</h4>
                                <p>this is our term.</p>
                                <p>this is also our term.</p>

                                <hr>

                                <h4>How to Upload Items</h4>

                                <p>You Upload by doing this and that.</p>

                                <h4>Paid Postings</h4>
                                <p>you pay by doing this.</p>
