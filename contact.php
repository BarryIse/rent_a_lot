        ...
        <div class="app-canvas">
            <div class="container">
                ...
                <div class="page contextual-page mb-0">
                    <div class="inner">
                        <div data-pin="assets/img/basic/pin.png" data-zoomlvl="5" data-address="texus usa" class="widget-map page-margin-fix" id="widget-map-1">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-4">
                            <div class="text-widget">
                                <div class="inner">
                                    <h4>About Us</h4>
                                    <p>As a leading entity in online rental services, We thrive to ensure the satisfaction of all parties</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-md-4">
